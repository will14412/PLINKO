...
abstract class SimTransform{
  ...
  String getClassName(Object o){
    String s = o.getClass().getSuperclass().getSimpleName();
   
    if(s.equals("SimTransform")){
      // this has not been subclaased so return the name of this class
      return o.getClass().getSimpleName(); 
    }else{
      // this HAS been subclaased so return the name of the base class
